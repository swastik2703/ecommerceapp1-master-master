                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Row(
                              children: List.generate(data['p_color'].length, (index) => Stack(
                                children: [VxBox().size(40, 40).roundedFull.color(Color(data['p_color'][index]).withOpacity(1.0)).margin(const EdgeInsets.symmetric(horizontal: 4))
                                    .make(),
                                ],
                              )
                              ),
                          ...
                          children: [
                            ...
                            Obx(
                               ...
                               children: [
                                 ...
                                 controller.quant.value.text.size(16).color(darkFontGrey).fontFamily(bold).make(),
                                 IconButton(onPressed: (){
                                   controller.increaseQuant(int.parse(data['p_quant']));
                                   controller.calculatePrice(int.parse(data['p_price']));
                                 },icon: const Icon(Icons.add)),
                                 10.widthBox,
                                 "(${data['p_quant']} Available)".text.color(textfieldGrey).make(),
                               ],
                              ),
                            ),
                          ],
            ...
            child: button(
              ...
              onpresss: (){
                controller.addtoCart(
                    ...
                    qty: controller.quant.value,
                    tprice: controller.totalPrice.value, context:context);
